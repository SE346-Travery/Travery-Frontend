...
class _$LocationImpl implements _Location {
  ...
  @override
  String toString() {
    return 'Location(id: $id, code: $code, name: $name, region: $region, description: $description, isActive: $isActive, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
