        ...
        children: [
          ...
          Text(
            ...
            style: textTheme.headlineMedium?.copyWith(
              fontSize: 20,
              fontWeight: FontWeight.bold, // Thêm độ đậm để tiêu đề nổi bật hơn
            ),
          ),
  ...
  Widget _buildInfoBox(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Icon(icon, color: AppTheme.primaryMain, size: 16),
          ...
          Text(
            ...
            style: textTheme.bodyMedium?.copyWith(
              fontWeight: FontWeight.bold,
              fontSize: 12,
              color: isHighlight ? AppTheme.primaryMain : AppTheme.neutralDark,
            ),
          ),
        ],
      ),
