...
import 'package:travery_frontend/ui/user/home/view/pages/home_page.dart';
import 'package:travery_frontend/ui/user/tour/booking/input/views/pages/tour_booking_input_page.dart';
import 'package:travery_frontend/ui/user/tour/views/pages/tour_detail_page.dart';
import 'package:travery_frontend/ui/user/tour/views/pages/tour_list_page.dart';
import 'routes.dart';
  ...
  static final GoRouter router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (context, state) => TourListPage(),
      ),
      GoRoute(
        path: Routes.tourdetail, // '/tour/:id'
        builder: (context, state) {
          final tourId = state.pathParameters['id']!; // param bắt buộc
          return TourDetailPage(tourId: tourId);
        },
      ),
      GoRoute(
        path: Routes.tourbookinginput, // '/tour/:id'
        builder: (context, state) {
          final tourId = state.pathParameters['id']!; // param bắt buộc
          return TourBookingInputPage(tourId: tourId);
        },
      ),
      // --- MAIN APP ROUTES ---
      GoRoute(
